...
print("Python has a built-in module that you can use to calculate mathematical statistics of numeric data. The statistics module was new in Python 3.4.")
import statistics



Statistics_Harmonic_Mean_def = "Statistics Harmonic Mean: The statistics.harmonic_mean() method calculates the harmonic mean (central location) of the given data set. Harmonic mean = The reciprocal of the arithmetic mean() of the reciprocals of the data. The harmonic mean is calculated as follows: If you have four values (a, b, c and d) - it will be equivalent to 4 / (1/a + 1/b + 1/c + 1/d)."
print(f"\n{Statistics_Harmonic_Mean_def}")
print("    # Calculate harmonic mean")
print(f"        print(statistics.harmonic_mean([40, 60, 80])) = {statistics.harmonic_mean([40, 60, 80])}")
print(f"        print(statistics.harmonic_mean([10, 30, 50, 70, 90])) = {statistics.harmonic_mean([10, 30, 50, 70, 90])}")




Statistics_Mean_def = "Statistics Mean: The statistics.mean() method calculates the mean (average) of the given data set. Tip: Mean = add up all the given values, then divide by how many values there are."
print(f"\n{Statistics_Mean_def}")
